...
newWidth = 2000
parser = argparse.ArgumentParser(description="Creating Minecraft Pixel Art from a source Image")

parser.add_argument('-img', metavar="img", default="1.png", nargs="?", type=str, help="Specify the path for the image to be turned into pixel art")
...
resName = ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
